...
class Router
{
    ...
    {
        $middlewarePath = __DIR__ . '/../../src/Middleware/' . $middleware . '.php';
        if (file_exists($middlewarePath)) {
            require_once $middlewarePath;
            // First, try to instantiate a class with the given name in the Src\Middleware namespace
            $className = '\\Src\\Middleware\\' . $middleware;
    ...
    private function executeControllerAction(string $controllerAction, array $params): void
    {
        ...
        error_log("DEBUG: Trying to load controller class: $controllerClass");
